...
public class MainActivity extends AppCompatActivity implements View.OnClickListener{
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            if(!obj.getBoolean("error")){
                                 sendName(obj.getString("nom"),Integer.parseInt(obj.getString("id_personnel")),Integer.parseInt(obj.getString("id_fonction")));
   ...
   /**********show Alert************/
    ...
    public void sendName(String name,int id,int id_fonction) {
        Intent myintent=new Intent(this,Choose_Equipement.class);
        //send Information
        Bundle b=new Bundle();
