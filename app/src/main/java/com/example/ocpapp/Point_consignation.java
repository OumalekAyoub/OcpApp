...
public class Point_consignation extends AppCompatActivity {
    private int id_user;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_point_consignation);
        ...
        adapter=new CustomAdapter2(this,data_list,id_occurence_plan,id_fonction);
    ...
    public List<Point> getPoints(final int id_plan){
        ...
        StringRequest stringRequest=new StringRequest(Request.Method.POST, Constants.Points,
