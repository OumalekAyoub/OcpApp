...
import com.example.ocpapp.Adapter.CustomAdapter5;
...
public class Point_deconsigner extends AppCompatActivity {
    private int id_user;
    ...
    private CustomAdapter5 adapter;
    private List<Point> data_list;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_point_deconsigner);
        ...
        adapter=new CustomAdapter5(this,data_list,id_occurence_plan,id_fonction);
        recyclerView.setAdapter(adapter);

        adapter.setOnItemClickListener(new CustomAdapter5.OnItemClickListener() {
            @Override
    ...
    public List<Point> getPoints(final int id_plan){
        ...
        StringRequest stringRequest=new StringRequest(Request.Method.POST, Constants.Points_deconsignation,
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            for (int i = 0; i < points.length(); i++) {
                                ...
                                p.setId_fonction(Integer.parseInt(pointJSON.getString("id_fonction")));
                                ...
                                if(pointJSON.getBoolean("is_decons")){
                                    p.setId_user_deconsigne(Integer.parseInt(pointJSON.getString("id_personnel_deconsigner2")));
