...
import com.example.ocpapp.Adapter.CustomAdapter6;
...
public class Point_historique extends AppCompatActivity {
    private int id_user;
    ...
    private CustomAdapter6 adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter=new CustomAdapter6(this,data_list,id_occurence_plan);
        recyclerView.setAdapter(adapter);

        adapter.setOnItemClickListener(new CustomAdapter6.OnItemClickListener() {
            @Override
