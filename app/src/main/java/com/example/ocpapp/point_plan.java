...
import com.example.ocpapp.Adapter.CustomAdapter8;
...
public class point_plan extends AppCompatActivity {
    private int id_user;
    ...
    private CustomAdapter8 adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter=new CustomAdapter8(this,data_list);
        recyclerView.setAdapter(adapter);

        adapter.setOnItemClickListener(new CustomAdapter8.OnItemClickListener() {
            @Override
    ...
    public List<Point> getPoints(final int id_plan){
        ...
        StringRequest stringRequest=new StringRequest(Request.Method.POST, Constants.Points_plan,
                        ...
                        try {
                            ...
                            for (int i = 0; i < points.length(); i++) {
                                ...
                                if(pointJSON.getBoolean("is_consigne")){
                                    p.setId_user_cons2(Integer.parseInt(pointJSON.getString("id_personnel_consigner2")));
